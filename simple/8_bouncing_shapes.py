...
class Triangle(Entity):
	...
	def produce(self):
		...
		for p in make_line(pt1, pt2, TRIANGLE_EDGE_SAMPLE_PTS):
			yield p
		
		for p in make_line(pt2, pt3, TRIANGLE_EDGE_SAMPLE_PTS):
			yield p

		for p in make_line(pt3, pt1, TRIANGLE_EDGE_SAMPLE_PTS):
			self.lastPt = p
			yield p
